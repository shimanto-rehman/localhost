...
CREATE TABLE "meal_config" (
    ...
    "meal_names" TEXT[] DEFAULT ARRAY['Lunch', 'Dinner'],
...
ALTER TABLE "bank_accounts" ADD CONSTRAINT "bank_accounts_apartment_id_fkey" FOREIGN KEY ("apartment_id") REFERENCES "apartments"("id") ON DELETE CASCADE ON UPDATE CASCADE;
